...
type Producto = { id: number; nombre: string; precio: number; categoria: string; activo: boolean; descripcion?: string };
      ...
      <div className="sticky top-0 z-10 bg-zinc-950 border-b border-zinc-800 px-4 py-4">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between mb-3">
            <div>
              <h1 className="text-2xl font-bold text-orange-400">La Felicitta</h1>
